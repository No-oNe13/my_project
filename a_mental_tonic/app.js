...
"The entire universe in its awesome vastness, important though it seems to us, is just one of a billion cells forming the wing of a butterfly which settles on the petal of a flower in one of many gardens in a place called life...",
...
"If life is but a dream, then live it...",
  ...
  //Get random quote from the array of quotes
  let quotesRandom = quotes [Math.floor(Math.random() * quotes.length)];
 // return quotesRandom

  //Insert the random element from the aray to the HTML document
